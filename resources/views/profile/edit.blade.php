        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <a href="#" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                    ...
                    <span class="ml-auto bg-orange-100 text-orange-600 text-xs font-semibold px-2 py-1 rounded-full">12</span>
                </a>
                ...
                <!-- Divider -->
                <div class="pt-4 pb-2">
                    <p class="px-4 text-xs font-semibold text-gray-400 uppercase">Settings</p>
                </div>

                <!-- Profile (Active) -->
                <a href="#" class="flex items-center space-x-3 px-4 py-3 bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-lg shadow-md">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex items-center justify-between px-8 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Search -->
                        <div class="relative">
                            <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent">
                ...
                <div class="max-w-4xl mx-auto space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-red-500">
                        <div class="bg-red-50 px-6 py-4">
                            ...
                            <p class="text-sm text-red-700 mt-2">Permanently delete your account. This action cannot be undone.</p>
                        </div>
                        <div class="p-6">
