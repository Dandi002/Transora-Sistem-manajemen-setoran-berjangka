                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                id="saving_plan_id"
                                name="saving_plan_id"
                                class="mt-1 block w-full h-11 px-4 rounded-xl border border-gray-300 bg-white text-gray-900 shadow-sm focus:outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 transition"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="mt-1 block w-full px-4 py-3 rounded-xl border border-gray-300 bg-white text-gray-900 shadow-sm resize-none focus:outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 transition"
                        >{{ old('alamat') }}</textarea>
